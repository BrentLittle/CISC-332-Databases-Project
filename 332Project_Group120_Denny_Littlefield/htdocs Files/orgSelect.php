...
<html>
    ...
    <body>
        ...
        <p>Select an organization you would like to view donations for:<p>
        ...
        <table>
            ...
            try
                ...
                $rows = $db->prepare("select name from organization");
                $rows->execute();
                ...
                foreach($rows as $row)
                {
                    ...
                    echo "<form action=\"donationsToOrg.php\" method=\"get\">";
